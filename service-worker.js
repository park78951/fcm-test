...
//   console.log("sw:push_event", event.data.text());

//   let title, body, icon, tag;

//   if (isJsonString(event.data.text())) {
//     const { title, body, icon, tag } = JSON.parse(
//       event.data && event.data.text()
//     );
//     title, body, icon, tag;
//   } else {
//     title = "Chrome Devtools Push";
//     body = "크롭에서 내려온 웹 알림입니다.";
//     icon = `${process.env.NEXT_PUBLIC_DOMAIN}/vercel.svg`;
//     tag = "default tag from chrome";
//   }
...
//   const urlToOpen = "https://quick.kakaomobility.com/";
